...
export default function ProductPage() {
  ...
  return (
    <>
      <Header.Root>
        <Header.Content className='max-w-screen-lg' />
      </Header.Root>
      <main className='flex justify-center'>
        <div className='m-6 flex w-full max-w-screen-lg items-start gap-6'>
          <Image
          ...
          <article className='flex w-0 flex-1 flex-col gap-3'>
            <Section>
              ...
              <p className='text-2xs'>
                This slim-fit turtleneck made of superfine wool is decorated
                with the jacquard lettering logo at the bottom of the neck for
                an iconic, minimalist touch.
              </p>
            </Section>
            <Section>
              <Section.Title>
                ...
                <Section.Info>
                  ...
                  <Section.InfoDetail>
                    ...
                    sizes). You can add multiple sizes to your profile. Our
                    system will automatically suggest sizes to add based on your
                    previous purchases and existing profile sizes.
                  </Section.InfoDetail>
                </Section.Info>
              </Section.Title>
              <Section.Content>
            ...
            <Section>
              <Section.Title>
                ...
                <Section.Info>
                  ...
                  <Section.InfoDetail>
                    A product style category is a high-level grouping of
                    products. Styles are a tad bit reminiscent of the typical
                    issue tracking tool’s "labels" feature. e.g. blazer, bomber,
                    cardigan, quilted, raincoat, jeans, tuxedos, etc.
                  </Section.InfoDetail>
                </Section.Info>
              </Section.Title>
              <Section.Content>
              ...
              <Section.Title>
                ...
                <Section.Info>
                  ...
                  <Section.InfoDetail>
                    ...
                    done by a brand or a designer. Often, collections are
                    created entirely by a single designer.
                  </Section.InfoDetail>
                </Section.Info>
              </Section.Title>
              <Section.Content>
            ...
            <Section>
              <Section.Title>
                ...
                <Section.Info>
                  <Section.InfoHeader>
                    The product’s brands. Collaborations can have multiple
                    brands.
                  </Section.InfoHeader>
                  <Section.InfoDetail>
                    A brand is a recognizable name. Brands with similar names
                    are given tiers. e.g. GUESS is given tier 1 while GBG and
                    GUESS FACTORY are given tier 2.
                  </Section.InfoDetail>
                </Section.Info>
              </Section.Title>
              <Section.Content>
            ...
            <Section>
              <Section.Title>
                ...
                <Section.Info>
                  <Section.InfoHeader>
                    The product’s available prices (MSRP, retail, resale) per
                    size and color.
                  </Section.InfoHeader>
                  <Section.InfoDetail>
                    A price is an encapsulation of a product’s value. A price
                    can be for all the sizes and color variants of a product
                    (e.g. when being sold at retail value) or specific to a
                    single size and color variant (e.g. GOAT, Ebay, StockX).
                  </Section.InfoDetail>
                </Section.Info>
              </Section.Title>
              <Section.Content>
