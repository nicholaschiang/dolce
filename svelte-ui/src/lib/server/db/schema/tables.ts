...
export const seasonName = pgEnum("SeasonName", [
  "RESORT",
  "SPRING",
  "PRE_FALL",
  "FALL",
...
export const link = pgTable(
  ...
  (table) => {
    return {
      ...
      collectionIdBrandIdKey: uniqueIndex(
        "Link_collectionId_brandId_key",
      ).using(
        "btree",
        table.collectionId.asc().nullsLast().op("int4_ops"),
        table.brandId.asc().nullsLast().op("int4_ops"),
      ),
      collectionIdRetailerIdKey: uniqueIndex(
        "Link_collectionId_retailerId_key",
      ).using(
        "btree",
        table.collectionId.asc().nullsLast().op("int4_ops"),
        table.retailerId.asc().nullsLast().op("int4_ops"),
...
export const review = pgTable(
  ...
  (table) => {
    return {
      authorIdCollectionIdKey: uniqueIndex(
        "Review_authorId_collectionId_key",
      ).using(
        "btree",
        table.authorId.asc().nullsLast().op("int4_ops"),
        table.collectionId.asc().nullsLast().op("int4_ops"),
...
export const article = pgTable(
  ...
  (table) => {
    return {
      authorIdCollectionIdKey: uniqueIndex(
        "Article_authorId_collectionId_key",
      ).using(
        "btree",
        table.authorId.asc().nullsLast().op("int4_ops"),
        table.collectionId.asc().nullsLast().op("int4_ops"),
      ),
      publicationIdTitleKey: uniqueIndex(
        "Article_publicationId_title_key",
      ).using(
        "btree",
