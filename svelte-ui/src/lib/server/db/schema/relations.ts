...
export const brandToRetailerRelations = relations(
  brandToRetailer,
  ({ one }) => ({
    brand: one(brand, {
...
export const countryToRetailerRelations = relations(
  countryToRetailer,
  ({ one }) => ({
    country: one(country, {
...
export const sizeEquivalentsRelations = relations(
  sizeEquivalents,
  ({ one }) => ({
    size_a: one(size, {
...
export const collectionToProductRelations = relations(
  collectionToProduct,
  ({ one }) => ({
...
export const materialToVariantRelations = relations(
  materialToVariant,
  ({ one }) => ({
...
export const collectionToUserRelations = relations(
  collectionToUser,
  ({ one }) => ({
    collection: one(collection, {
...
export const collectionToShowRelations = relations(
  collectionToShow,
  ({ one }) => ({
    collection: one(collection, {
